            ...
            <div class="nav">
                ...
                <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="scane">Tambah Scanes</a>
                        <a class="nav-link" href="tampil_scane">Tabel Scanes</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="AnimasiLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="animation">Tambah Animasi</a>
                        <a class="nav-link" href="tampil_animasi">Tampil Animasi</a>
                    </nav>
                </div>
